...
msr_dataset = ImageFolder(DATA_ROOT+'/Dark-Image-Data_multiscaleRetinex/',transform=transform)
...
for epoch in range(NUM_EPOCHS):
    ...
    for dark_data,lime_data,msr_data,bimef_data,ying_data in zip(dark_loader,lime_loader,msr_loader,bimef_loader,ying_loader):
